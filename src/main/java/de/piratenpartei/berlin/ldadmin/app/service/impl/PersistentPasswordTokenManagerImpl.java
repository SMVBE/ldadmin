...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see de.piratenpartei.berlin.ldadmin.app.service.impl.PasswordTokenManager#generateRecoveryToken(de.piratenpartei.berlin.ldadmin.app.model.User)
     */
    @Override
    ...
    /**
     * @see de.piratenpartei.berlin.ldadmin.app.service.impl.PasswordTokenManager#isRecoveryTokenValid(de.piratenpartei.berlin.ldadmin.app.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see de.piratenpartei.berlin.ldadmin.app.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
