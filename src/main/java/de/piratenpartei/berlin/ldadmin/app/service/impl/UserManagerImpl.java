...
import de.piratenpartei.berlin.ldadmin.app.dao.UserDao;
import de.piratenpartei.berlin.ldadmin.app.model.User;
import de.piratenpartei.berlin.ldadmin.app.service.MailEngine;
import de.piratenpartei.berlin.ldadmin.app.service.UserExistsException;
import de.piratenpartei.berlin.ldadmin.app.service.UserManager;
import de.piratenpartei.berlin.ldadmin.app.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "de.piratenpartei.berlin.ldadmin.app.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see de.piratenpartei.berlin.ldadmin.app.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
