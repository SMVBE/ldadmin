...
@Controller
@RequestMapping("/admin/pseudonymMembers")
public class PseudonymMembersFileController extends BaseFormController {
	...
	public ModelAndView handleRequest(HttpServletRequest request,
		...
		return new ModelAndView("admin/pseudonymMembers", model.asMap());
	}
}
