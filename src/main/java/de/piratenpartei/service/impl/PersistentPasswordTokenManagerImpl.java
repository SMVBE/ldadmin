...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see de.piratenpartei.service.impl.PasswordTokenManager#generateRecoveryToken(de.piratenpartei.model.User)
     */
    @Override
    ...
    /**
     * @see de.piratenpartei.service.impl.PasswordTokenManager#isRecoveryTokenValid(de.piratenpartei.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see de.piratenpartei.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
