...
import de.piratenpartei.dao.UserDao;
import de.piratenpartei.model.User;
import de.piratenpartei.service.MailEngine;
import de.piratenpartei.service.UserExistsException;
import de.piratenpartei.service.UserManager;
import de.piratenpartei.service.UserService;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "de.piratenpartei.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see de.piratenpartei.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
