...
@Controller
@RequestMapping("/admin/upload/leaving*")
public class LeavingMemberFileUploadController extends BaseFormController {

	public LeavingMemberFileUploadController() {
		super();
		setCancelView("redirect:/home");
		setSuccessView("redirect:/admin/leavingMembers");
	}
	...
	public String onSubmit(FileUpload fileUpload, BindingResult errors,
		...
		String link = "/admin/leavingMembersSubmit?file=";
