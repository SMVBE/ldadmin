...
<div class="col-sm-12">
	<display:table name="memberList" cellspacing="0" cellpadding="0"
		...
		<display:column property="accreditation" escapeXml="true"
			...
			url="/admin/leavingMembersSubmit" paramId="name"
...
<div class="col-sm-12">
	<a class="btn btn-success btn-xs btn-block"
		href="${ctx}/admin/leavingMembersSubmit?go=1&file=${fileName}"
		title="<fmt:message key='ldadmin.menu.members.leaving' />"> <fmt:message
			key="ldadmin.members.submit.leaving.list">
