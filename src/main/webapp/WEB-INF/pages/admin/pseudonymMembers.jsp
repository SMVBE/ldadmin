...
<div class="col-sm-12">
	<display:table name="fileList" cellspacing="0" cellpadding="0"
		requestURI="" defaultsort="1" id="files" pagesize="5"
		...
		<display:column property="name" escapeXml="true" sortable="true"
			titleKey="file.name" url="/admin/pseudonymMembersSubmit"
		...
		<display:column property="lastModified"
			...
			titleKey="ldadmin.files.delete" url="/admin/pseudonymMembers"
...
<div class="col-sm-12">
	<display:table name="protocolList" cellspacing="0" cellpadding="0"
		...
		<display:column escapeXml="false" sortable="false"
			titleKey="protocol.view" url="/admin/pseudonymMembers" paramId="protocol"
			paramProperty="name">
