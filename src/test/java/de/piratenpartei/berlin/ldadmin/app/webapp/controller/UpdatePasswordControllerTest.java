...
import de.piratenpartei.berlin.ldadmin.app.webapp.controller.UpdatePasswordController;
...
public class UpdatePasswordControllerTest extends BaseControllerTestCase {
    ...
    public void testShowResetPasswordFormBadToken() throws Exception {
        ...
        assertNotNull(request.getSession().getAttribute(Constants.ERRORS_MESSAGES_KEY));
    }
    ...
    public void testResetPasswordBadToken() throws Exception {
        ...
        assertNull(request.getSession().getAttribute(Constants.SUCCESS_MESSAGES_KEY));
        assertNotNull(request.getSession().getAttribute(Constants.ERRORS_MESSAGES_KEY));
    }
